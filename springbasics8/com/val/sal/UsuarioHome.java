package com.val.sal;
// Generated 04-oct-2016 6:56:19 by Hibernate Tools 5.1.0.Alpha1
...
public class UsuarioHome {
	...
	public Usuario findById(java.lang.Integer id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("com.val.sal.Usuario", id);
			if (instance == null) {
	...
	public List<Usuario> findByExample(Usuario instance) {
		...
		try {
			List<Usuario> results = (List<Usuario>) sessionFactory.getCurrentSession()
					.createCriteria("com.val.sal.Usuario").add(create(instance)).list();
